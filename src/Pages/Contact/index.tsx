      ...
      <div className="flex one">
        <div className="glassPanel panelBottomSpacing">
          ...
          <p>
            ...
            we stay up-to-date with industry trends and can help you achieve
            your business goals. From migrating to the cloud, to building new
            applications and ensuring scalability, security and compliance.
            Let's schedule a consultation and take the first step towards
